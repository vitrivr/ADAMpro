...
docker exec -i --tty=false spark spark-submit --master "local[4]" --deploy-mode client --class org.vitrivr.adampro.main.Startup /target/scala-2.10/ADAMpro-assembly-0.1.0.jar
