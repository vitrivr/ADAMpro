...
cp -R $DIR/conf $DIR/target/conf
rm $DIR/target/application.conf
docker run -d -e "SPARK_CONF_DIR=/target/conf" --net=adampronw -p 8088:8088 -p 8042:8042 -p 4040:4040 -p 5890:5890 -v $DIR/target:/target -h spark --name spark --net-alias spark sparkj1.8 -d