...
# run container
docker run --net=vitrvrnw -d -h adampro --name adampro --net-alias adampro -p 5005:5005 -p 5890:5890 -p 9099:9099 -p 5432:5432 -p 9000:9000 -p 4040:4040 -p 10088:10088 -d adampro
