package org.vitrivr.adampro.query.ast.generic
...
import org.vitrivr.adampro.query.query.InformationLevels._
import org.vitrivr.adampro.query.execution.{ProgressiveObservation, ProgressiveQueryStatus}
...
abstract class QueryExpression(id: Option[String]) extends Serializable with Logging {
  ...
  private[ast] var prepared = false
  ...
  /**
    ...
    * @return
    */
  protected def run(options: Option[QueryEvaluationOptions], filter: Option[DataFrame])(tracker: QueryTracker)(implicit ac: SharedComponentContext): Option[DataFrame]
