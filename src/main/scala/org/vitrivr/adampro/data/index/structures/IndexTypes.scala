...
import org.vitrivr.adampro.data.index.structures.ecp.{ECPIndex, ECPIndexGeneratorFactory}
import org.vitrivr.adampro.data.index.structures.lsh.{LSHIndex, LSHIndexGeneratorFactory}
import org.vitrivr.adampro.data.index.structures.mi.{MIIndex, MIIndexGeneratorFactory}
import org.vitrivr.adampro.data.index.structures.pq.{PQIndex, PQIndexGeneratorFactory}
import org.vitrivr.adampro.data.index.structures.sh.{SHIndex, SHIndexGeneratorFactory}
import org.vitrivr.adampro.data.index.structures.va._
import org.vitrivr.adampro.data.index.{Index, IndexGeneratorFactory}
...
object IndexTypes {
  ...
  /**
    *
    */
  val values = Seq(ECPINDEX, LSHINDEX, PQINDEX, MIINDEX, SHINDEX, VAFINDEX, VAVINDEX, VAPLUSINDEX)
