...
import org.vitrivr.adampro.query.planner.IndexCollectionFactory.{ExistingIndexCollectionOption, NewIndexCollectionOption}
import org.vitrivr.adampro.query.planner.QueryCollectionFactory.{LoggedQueryCollectionOption, RandomQueryCollectionOption}
import org.vitrivr.adampro.query.planner._
...
/**
  ...
  * March 2016
  */
class DataDefintion extends AdamDefinitionGrpc.AdamDefinition with Logging {
