...
/**
  ...
  * October 2015
  */
class ECPIndex(val indexname: IndexName, val entityname: EntityName, private[index] val df: DataFrame, private[index] val metadata: ECPIndexMetaData)(@transient implicit val ac : AdamContext)
  extends Index {
