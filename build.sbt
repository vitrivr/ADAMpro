...
//adampro core libs
libraryDependencies ++= Seq(
  "org.apache.spark" %% "spark-core" % "1.6.1" % "provided" excludeAll ExclusionRule("org.apache.hadoop"),  //make sure that you use the same spark version as in your deployment!
